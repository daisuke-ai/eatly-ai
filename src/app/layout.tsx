...
export const metadata: Metadata = {
  ...
  description: "Marketing Automation for Restaurant Growth. Eatly.ai handles your calls, messages, marketing, and loyalty—so you can focus on running your restaurant.",
